...
const Header = () => {
  ...
  return (
<div className="flex lg:space-x-[600px] pb-2 mb-10" style={{ backgroundColor: '#225452 ' }}>
      <div>
        ...
        <ul className="flex mt-12 ">
          ...
          <li>
            {logged ? (
              ...
              <Link to="/signup">
                <p className="ml-[900px] bg-slate-200 p-2 rounded-[10px] -m-2">
                  Create Account
                </p>
              </Link>
            )}
      ...
      : <div>
        <Link to="/consultancy">
        <button className="ml-[680px] bg-slate-500 text-white p-3 rounded-[10px] w-[90px]">Video Consultancy</button>
        </Link>
        <Link to="/alert">
        <button className="ml-[680px] bg-red-600 text-white p-3 rounded-[10px] w-[90px]">SOS</button>
        </Link>
