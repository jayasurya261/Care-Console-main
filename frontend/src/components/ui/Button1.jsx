...
>
  ...
  >
    <span
      class="absolute top-0 right-0 w-9 h-6 rotate-45 translate-x-1/2 -translate-y-1/2 bg-white"
    ></span>
  </span>
  <span
  ...
  >
    <span
      class="absolute top-0 right-0 w-9 h-5 rotate-45 translate-x-1/2 -translate-y-1/2 bg-white"
    ></span>
  </span>
  <span
