...
const AllIsolationRequest = () => {
  ...
  useEffect(() => {
    const fetchRequests = async () => {
      try {
        const response = await axios.get('http://localhost:3000/user/illness/my-requests');
  ...
  return (
    <div className='flex'>
      ...
      <div className='flex flex-col p-4 w-full'>
        ...
        <h1 className='text-3xl font-bold mb-6'>All Isolation Requests</h1>
...
export default AllIsolationRequest;
